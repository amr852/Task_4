...
describe('Authentication controller integration', () => {
  ...
  */
 test('logs in an existing user and returns a JWT for immediate use', async () => {
  ...
  // Successful login should return 200 alongside a token and the public portion of the user record.
